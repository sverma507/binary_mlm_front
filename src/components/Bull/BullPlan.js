...
const BullPlan = () => {
	...
	const handleBuyBull = async () => {
		...
		const provider = new ethers.providers.Web3Provider(window.ethereum, 'bnb');
		...
		try {
			...
			const transaction = await contract.purchaseBull();
			...
			<section className="relative pt-28 py-16 bg-gradient-to-r from-blue-900 to-black text-gray-100 overflow-hidden">
				<div className="container mx-auto px-6 text-center">
					...
					<p className="mt-6 text-xl text-gray-300 leading-relaxed">
						Your journey to financial independence begins here. Invest $60 and start earning daily profits with our automated platform. Unlock exclusive opportunities and take control of your future.
					</p>
				</div>
				...
				<div className="mt-24 text-center text-white">
					...
					<p className="text-xl text-gray-400 mb-12">
						With the Bull Plan, you are just a few clicks away from securing your spot in a world of financial opportunities. Our automated trading platform ensures that your investment works tirelessly to bring you consistent returns. Don’t wait—get started today!
					</p>
