...
const navigate = useNavigate();
  ...
  return (
    ...
    <Carousel/>
      ...
      >
        <div className="bg-white bg-opacity-10 backdrop-blur-lg w-[90%] max-w-md p-6 rounded-3xl text-center text-white">
      ...
      <div className="bg-black py-10 px-2 flex flex-col items-center">
        ...
        <div className="flex justify-center mt-6">
          <div className="p-4 md:p-6 border-2 hover:bg-slate-300 hover:text-black cursor-pointer hover:border-blue-700 border-slate-400 rounded-full text-2xl md:text-4xl text-white transition duration-200"
           onClick={() => {auth?.token ? navigate('/bull') : navigate('/login')}}
          >
            Explore Features
          </div>
        </div>
