...
//     const [successMessage, setSuccessMessage] = useState('');
//     const [referredBy, setReferredCode] = useState('');
//     const [walletDetected, setWalletDetected] = useState(false); // Track wallet detection
//     const [popupMessage, setPopupMessage] = useState(''); // For showing popups
//     const [popupVisible, setPopupVisible] = useState(false); // Toggle popup visibility
...
//     // Detect Wallet Provider on component mount
//     useEffect(() => {
//         if (window.ethereum) {
//             setWalletDetected(true); // Wallet detected
//         } else {
//             setWalletDetected(false); // No wallet detected
//         }
//     }, []);
...
//         if (!walletDetected) {
//             showPopup('No wallet detected. Please install MetaMask or Trust Wallet.', 'error');
//             return; // Stop form submission if no wallet is detected
//         }
