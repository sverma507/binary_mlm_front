...
const UserTree = () => {
  ...
  return (
    <Layout>
      <div style={{ width: '100%', height: '600px', backgroundColor: 'white', color: 'white' }}>
        <Tree
          data={treeData}
          orientation="vertical"  // Vertical tree layout
          translate={{ x: 300, y: 100 }} // Adjust translation to center the tree
          nodeSize={{ x: 200, y: 100 }}  // Adjust node size for better spacing
          ...
          renderCustomNodeElement={({ nodeDatum, toggleNode }) => (
            <g>
              ...
              <text fill="white" x="20" y="20">
                Wallet: {nodeDatum.attributes.wallet}
              </text>
              <text fill="white" x="20" y="35">
                Rank: {nodeDatum.attributes.rank}
              </text>
              <text fill={nodeDatum.attributes.isActive === 'Active' ? 'lightgreen' : 'red'} x="20" y="50">
